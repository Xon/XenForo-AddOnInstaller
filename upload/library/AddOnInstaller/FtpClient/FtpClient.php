 ...
 */
class AddOnInstaller_FtpClient_FtpClient implements Countable
{
	/**
	 ...
	 *
	 * @var AddOnInstaller_FtpClient_FtpWrapper
	 */
	private $ftp;
	 ...
	 *
	 * @throws AddOnInstaller_FtpClient_FtpException  If ftp extension is not loaded.
	 */
	public function __construct($connection = null)
	{
		if (!extension_loaded('ftp'))
		{
			throw new AddOnInstaller_FtpClient_FtpException('FTP extension is not loaded!');
		}
		...
		$this->setWrapper(new AddOnInstaller_FtpClient_FtpWrapper($this->conn));
	}
	...
	public function connect($host, $ssl = false, $port = 21, $timeout = 90)
	{
		...
		if (!$this->conn)
		{
			throw new AddOnInstaller_FtpClient_FtpException('Unable to connect');
		}
	 ...
	 * Get the wrapper
	 *
	 * @return AddOnInstaller_FtpClient_FtpWrapper
	 */
	 ...
	 *
	 * @return AddOnInstaller_FtpClient_FTPClient If the login is incorrect
	 */
	public function login($username = 'anonymous', $password = '')
	{
		...
		if ($result === false)
		{
			throw new AddOnInstaller_FtpClient_FtpException('Login incorrect');
		}
	...
	public function up()
	{
		...
		if ($result === false)
		{
			throw new AddOnInstaller_FtpClient_FtpException('Unable to get parent folder');
		}
	...
	public function nlist($directory = '.', $recursive = false, $filter = 'sort')
	{
		...
		{
			throw new AddOnInstaller_FtpClient_FtpException('"' . $directory . '" is not a directory');
		}
		...
		if ($files === false)
		{
			throw new AddOnInstaller_FtpClient_FtpException('Unable to list directory');
		}
	...
	public function isDir($directory)
	{
		...
		if ($pwd === false)
		{
			throw new AddOnInstaller_FtpClient_FtpException('Unable to resolve the current directory');
		}
	 ...
	 *
	 * @return AddOnInstaller_FtpClient_FtpClient
	 * @throws AddOnInstaller_FtpClient_FtpException When the transfer fails
	 */
	public function putFromString($remote_file, $content)
	{
		...
		throw new AddOnInstaller_FtpClient_FtpException('Unable to put the file "' . $remote_file . '"');
	}
	...
	public function putFromPath($local_file)
	{
		...
		throw new AddOnInstaller_FtpClient_FtpException(
	...
	public function rawToType($permission)
	{
		...
		{
			throw new AddOnInstaller_FtpClient_FtpException('The "$permission" argument must be a string, "'
	 ...
	 *
	 * @param  AddOnInstaller_FtpClient_FtpWrapper $wrapper
	 *
	 * @return AddOnInstaller_FtpClient_FtpClient
	 */
	protected function setWrapper(AddOnInstaller_FtpClient_FtpWrapper $wrapper)
	{
		$this->ftp = $wrapper;
